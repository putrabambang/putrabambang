...
<body onload="window.print()">
    ...
    <p class="text-center">Setiap Pengembalian/Retur Barang wajib Menunjukan struk Max 3 hari </p>
    <p class="text-center">===================================</p>
    <p class="text-center">Menerima Pembuatan Aplikasi Toko</p>
    <p class="text-center">Pemasangan CCTV</p>
