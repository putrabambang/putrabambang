...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'level:1,2'], function () {
     ...
     //   Route::get('/transaksi/nota-besar', [PenjualanController::class, 'notaBesar'])->name('transaksi.nota_besar');
        ...
        Route::post('/laporanbarang/data', [LaporanBarangController::class, 'data'])->name('laporanbarang.data');
        Route::get('/laporanbarang/export_excel/{awal}/{akhir}', [LaporanBarangController::class, 'exportExcel'])->name('laporanbarang.export_excel');
        Route::get('/laporanbarang/export_pdf/{awal}/{akhir}', [LaporanBarangController::class, 'exportPDF'])->name('laporanbarang.export_pdf');
